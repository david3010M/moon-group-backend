...
class AuthController extends Controller
{
    /**
     * @OA\Post (
     *       path="/moon-group-backend/public/api/login",
     *       tags={"Authentication"},
     *       summary="Login user",
     *       @OA\RequestBody(
     *           required=true,
...
//                'expires_at' => Carbon::parse($token->accessToken->expires_at)->toDateTimeString(),
    ...
    /**
     * @OA\Get (
     *     path="/moon-group-backend/public/api/authenticate",
     *     tags={"Authentication"},
     *     security={{"bearerAuth": {}}},
    ...
    /**
     * @OA\Get (
     *     path="/moon-group-backend/public/api/logout",
     *     tags={"Authentication"},
     *     summary="Logout user",
     *     security={{"bearerAuth": {}}},
     *     @OA\Response(
    ...
    /**
     * @OA\Get (
     *     path="/moon-group-backend/public/api/logs",
     *     tags={"Logs"},
     *     summary="Get logs",
     *     security={{"bearerAuth": {}}},
